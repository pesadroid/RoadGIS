...
public class SaveVerticalDesignPopup extends PopupWindow{

	private RoadGISApplication app = null;
	private myIcon iconQ = new myIcon("question_mark") ;

	public SaveVerticalDesignPopup(RoadGISApplication app) {
		this.app = app;
	}
	
	public void build() {
		popup = new RoadGISPopup("Save Vertical Design File") ;
		...
		JLabel myMsg = new JLabel("Do you want to save current vertical design?") ;
